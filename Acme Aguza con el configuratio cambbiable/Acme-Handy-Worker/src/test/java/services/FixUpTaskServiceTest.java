...
public class FixUpTaskServiceTest extends AbstractTest {
	...
	public void testSaveFixUpTask() {
		...
		final FixUpTask todelete = this.fixUpTaskService.findOne(17579);

		this.customerService.deleteFixUpTaskCustomer(todelete);

		Assert.isTrue(this.fixUpTaskService.findOne(17579) == null);
