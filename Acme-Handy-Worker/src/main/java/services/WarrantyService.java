...
public class WarrantyService {
	...
	public List<Warranty> findFinalWarranties() {

		final Collection<Warranty> aux = this.findAll();

		final List<Warranty> res = new ArrayList<>();

		for (final Warranty warranty : aux)
			if (warranty.getIsFinal())
				res.add(warranty);
