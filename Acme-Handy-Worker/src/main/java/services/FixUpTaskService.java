...
public class FixUpTaskService {
	...
	public Integer numFixUpTaskByCustomer(final Customer customer) {

		final Collection<FixUpTask> aux = this.customerService.fixUpTasksCreatedByCustomer(customer);
		final Integer result = aux.size();
		return result;
	}
